...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "auto_insights", sa.Boolean(), nullable=True, server_default=sa.true()
        ),
        sa.Column(
            "anomaly_detection", sa.Boolean(), nullable=True, server_default=sa.true()
        ),
        sa.Column(
            "predictive_alerts", sa.Boolean(), nullable=True, server_default=sa.true()
        ),
        sa.Column(
            "peer_comparison", sa.Boolean(), nullable=True, server_default=sa.false()
        ),
        # --- Notification preferences ---
        sa.Column(
            "anomaly_alerts", sa.Boolean(), nullable=True, server_default=sa.true()
        ),
        sa.Column(
            "pattern_insights", sa.Boolean(), nullable=True, server_default=sa.true()
        ),
        sa.Column(
            "weekly_summary", sa.Boolean(), nullable=True, server_default=sa.true()
        ),
        sa.Column(
            "spending_warnings", sa.Boolean(), nullable=True, server_default=sa.true()
        ),
        # --- Budget automation preferences ---
        sa.Column(
            "auto_adapt_enabled", sa.Boolean(), nullable=True, server_default=sa.true()
        ),
        sa.Column(
