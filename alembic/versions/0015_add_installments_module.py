...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        # Demographics
        sa.Column(
            "age_group", sa.String(length=10), nullable=False, server_default="25-34"
        ),
        # Existing obligations
        sa.Column(
            "credit_card_debt", sa.Boolean(), nullable=False, server_default="false"
        ),
        sa.Column(
            "credit_card_payment",
        ...
        # Future plans
        sa.Column(
            "planning_mortgage", sa.Boolean(), nullable=False, server_default="false"
        ),
        # Metadata
        sa.Column(
            "updated_at",
    ...
    op.create_index(
        "ix_user_financial_profiles_user_id", "user_financial_profiles", ["user_id"]
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "category", sa.String(length=50), nullable=False, server_default="other"
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "payment_to_income_ratio", sa.Numeric(precision=5, scale=2), nullable=False
        ),
        sa.Column(
            "remaining_balance", sa.Numeric(precision=12, scale=2), nullable=False
        ),
        # Risk factors (JSON)
        ...
        sa.ForeignKeyConstraint(
            ["installment_id"], ["installments.id"], ondelete="SET NULL"
        ),
    )
    op.create_index(
        "ix_installment_calculations_user_id", "installment_calculations", ["user_id"]
    )
    op.create_index(
        "ix_installment_calculations_installment_id",
        "installment_calculations",
        ["installment_id"],
    )
    op.create_index(
        "ix_installment_calculations_calculated_at",
        "installment_calculations",
        ["calculated_at"],
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "installments_completed", sa.Integer(), nullable=False, server_default="0"
        ),
        sa.Column(
            "calculations_performed", sa.Integer(), nullable=False, server_default="0"
        ),
        sa.Column(
            "calculations_declined", sa.Integer(), nullable=False, server_default="0"
        ),
        # Streak tracking
        sa.Column(
            "days_without_new_installment",
            sa.Integer(),
            nullable=False,
            server_default="0",
        ),
    ...
    op.create_index(
        "ix_installment_achievements_user_id", "installment_achievements", ["user_id"]
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        "ix_installment_calculations_calculated_at", "installment_calculations"
    )
    op.drop_index(
        "ix_installment_calculations_installment_id", "installment_calculations"
    )
