...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            "status", sa.String(20), default="active"
    ...
    op.create_index(
        "ix_challenge_participations_user_id", "challenge_participations", ["user_id"]
    )
    op.create_index(
    ...
    op.create_index(
        "ix_challenge_participations_month", "challenge_participations", ["month"]
    )
    op.create_index(
        "ix_challenge_participations_status", "challenge_participations", ["status"]
    )
...
def downgrade():
    ...
    op.drop_index(
        "ix_challenge_participations_challenge_id", "challenge_participations"
    )
