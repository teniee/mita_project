...
def save_calendar_for_user(db: Session, user_id: int, calendar: Dict[str, Dict[str, float]]):
...
def fetch_calendar(db: Session, user_id: int, year: int, month: int) -> Dict[str, Dict[str, float]]:
    results = (
        db.query(DailyPlan)
