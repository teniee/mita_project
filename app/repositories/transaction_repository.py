...
class TransactionRepository(BaseRepository[Transaction]):
    ...
    async def get_by_category(
        self, user_id: UUID, category: str, limit: int = 50
    ) -> List[Transaction]:
    ...
    async def get_largest_transactions(
        self, user_id: UUID, limit: int = 10, days: int = 30
    ) -> List[Transaction]:
    ...
    async def search_transactions(
        self, user_id: UUID, search_term: str, limit: int = 50
    ) -> List[Transaction]:
        ...
        async with get_async_db_context() as db:
            ...
            return {
                ...
                "most_frequent_category": (
                    category_result.category if category_result else None
                ),
                "period_days": days,
            }
