...
CONFIG_DIR = Path(__file__).resolve().parent.parent.parent / 'config' / 'country_profiles'
...
def current_season(date: datetime.date = None):
    ...
    return 'winter' if d.month in (12,1,2) else 'summer' if d.month in (6,7,8) else 'neutral'
