...
class ErrorEvent:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if self.additional_context:
            data["additional_context"] = self._safe_serialize_context(
            ...
            "attachments": [
                {
                    ...
                    "fields": [
                        ...
                        {
                            "title": "Endpoint",
                            "value": alert_data.get("endpoint", "N/A"),
                            "short": True,
                        },
                        {
                            "title": "Time",
...
class ErrorMonitor:
        ...
        try:
            ...
            with sentry_sdk.push_scope() as scope:
                ...
                if additional_context:
                    ...
                    safe_context = error_event._safe_serialize_context(
                        additional_context
                    )
    ...
    def get_health_status(self) -> Dict[str, Any]:
        ...
        critical_errors = len(
            [
                e
                for e in self.aggregator.error_patterns.values()
                for error in e
