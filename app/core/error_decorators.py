...
def handle_errors(
    ...
    transform_exceptions: Optional[
        Dict[Type[Exception], Type[StandardizedAPIException]]
    ] = None,
    log_level: str = "auto",
        ...
        async def async_wrapper(*args, **kwargs):
            try:
                ...
                return StandardizedErrorHandler.create_response(
                    ...
                    request,
                    user_id,
                    {"original_error": str(e), "traceback": _tb.format_exc()},
                )
...
def handle_auth_errors(func: Callable) -> Callable:
    ...
    return handle_errors(transform_exceptions=exception_mapping, log_level="warning")(
        func
    )
...
def handle_validation_errors(func: Callable) -> Callable:
    ...
    return handle_errors(transform_exceptions=exception_mapping, log_level="info")(func)
...
class ErrorHandlingMixin:
    ...
    def handle_database_error(
        self, error: SQLAlchemyError, context: Optional[Dict[str, Any]] = None
    ):
    ...
    def handle_validation_error(
        ...
        raise ValidationError(
            message, ErrorCode.VALIDATION_INVALID_FORMAT, details=error_details
        )
    ...
    def handle_business_logic_error(
        self, message: str, error_code: str = ErrorCode.BUSINESS_INVALID_OPERATION
    ):
