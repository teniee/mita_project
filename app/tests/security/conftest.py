...
class SecurityTestHelper:
    ...
    @staticmethod
    def assert_no_sensitive_data_in_response(
        response_text: str, sensitive_data: list
    ) -> None:
        ...
        for sensitive_item in sensitive_data:
            if isinstance(sensitive_item, str):
                assert (
                    sensitive_item.lower() not in response_lower
...
def pytest_configure(config):
    ...
    config.addinivalue_line("markers", "concurrent: mark test as a concurrency test")
