...
class TestResilientGPTService:
    ...
    async def test_timeout_error(self, gpt_service):
        ...
        assert "longer than usual" in result.lower() or "try again" in result.lower()
...
class TestResilientGoogleAuthService:
    ...
    def mock_user_repository(self):
        ...
        with patch('app.services.resilient_google_auth_service.get_user_repository') as mock:
            mock_repo = Mock()
    ...
    @pytest.mark.asyncio
    async def test_convenience_function(self, mock_user_repository):
        ...
        with patch('app.services.resilient_google_auth_service.get_google_auth_service') as mock_service:
