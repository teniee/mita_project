...
@router.@router.get("/emergency-diagnostics")
...
@router.@router.get("/security/password-config")
...
async def get_user_blacklisted_tokens(
    ...
    try:
        from app.services.token_blacklist_service import get_blacklist_service
from app.middleware.comprehensive_rate_limiter import apply_endpoint_rate_limiting
