...
def generate_calendar(calendar_id: str, start_date: date, num_days: int, budget_plan: Dict[str, float]):
    calendar_days = build_calendar(start_date, num_days, budget_plan)
    save_calendar_for_user(calendar_id, start_date.year, start_date.month, calendar_days)
