...
class ProgressTracker:
    def __init__(self):
        self.history = {}  # format: {user_id: {"YYYY-MM": {"spent": x, "saved": y}}}

    def log_month(self, user_id: str, year: int, month: int, calendar: Dict, income: float, country: str, region: str):
