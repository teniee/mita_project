...
class StandardizedResponse:
    ...
    def error(
        ...
        return StandardizedErrorHandler.create_response(
            error, request, user_id, extra_context
        )
    ...
    def paginated(
        ...
        return StandardizedResponse.success(data=data, message=message, meta=meta)
...
class FinancialResponseHelper:
    ...
    @staticmethod
    def budget_updated(
        budget_data: Dict[str, Any], impact_analysis: Optional[Dict[str, Any]] = None
    ) -> JSONResponse:
    ...
    def analysis_result(
        ...
        return StandardizedResponse.success(
            data=analysis_data, message="Analysis completed successfully", meta=meta
        )
...
class AuthResponseHelper:
    ...
    def login_success(
        ...
        response_data = {**tokens, "user": user_data}
        ...
        return StandardizedResponse.success(
            data=response_data, message="Login successful", meta=meta if meta else None
        )
